...
public class AttributeGroupFilterTestCase {
    ...
    public void testAttributeGroupFilterStandalone() throws Exception {
        ...
        final String xmlFragment = "<xsd:schema xmlns=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" >"
    ...
    public void testAttributeGroupFilterWithComplexTypeAsParent() throws Exception {
        ...
        Assert.assertEquals("javaee:web-commonType", metadata.getClassList().get(0).getReferences().get(0).getRef(),
            "javaee:web-commonType");
        Assert.assertEquals("javaee:web-common-attributes", metadata.getClassList().get(0).getReferences().get(1)
            .getRef(), "javaee:web-common-attributes");
        DomTestUtil.assertClassAttribute(metadata.getClassList().get(0).getElements().get(2),
            "<xsd:attribute name=\"id\" type=\"xsd:ID\"");
    }
