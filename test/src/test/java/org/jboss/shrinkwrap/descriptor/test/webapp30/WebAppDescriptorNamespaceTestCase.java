...
public class WebAppDescriptorNamespaceTestCase {
    ...
    public void shouldAddDefaultNamespaces() throws Exception {
        final String app = create().addDefaultNamespaces().exportAsString();
    ...
    public void testReturnAllNamespaces() throws Exception {
        final List<String> nsList = create().addDefaultNamespaces().getNamespaces();
    ...
    public void testRemoveAllNamespaces() throws Exception {
        final String app = create().version("3.0").addDefaultNamespaces().removeAllNamespaces().exportAsString();
    ...
    public void shouldAddNamespace() throws Exception {
        ...
        final String app1 = create().addNamespace("xmlns", "http://java.sun.com/xml/ns/javaee").exportAsString();
        assertDefaultNamespace(app1, expectedJavaEENamespace);

        // check xml namespace only
        final String app2 = create().addNamespace("xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance")
            .exportAsString();
        ...
        final String app3 = create()
            ...
            .addNamespace("xsi:schemaLocation",
                "http://java.sun.com/xml/ns/javaee http://java.sun.com/xml/ns/javaee/web-app_3_0.xsd").exportAsString();
