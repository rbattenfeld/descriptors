...
public class BeansDescriptorTestCase {
    ...
    public void shouldHaveCorrectSchemaLocation() {
        ...
        // when
        final String descriptorXml = create().alternatives(FactoryJavaEEImpl.instance().alternatives10()
    ...
    public void shouldNotBeAbleToAddNonAlternativeStereoType() {
        create().alternatives(FactoryJavaEEImpl.instance().alternatives10().clazz(Override.class.getName()));
    }

    @Test
    public void shouldBeAbleToAddAlternativeStereoType() throws Exception {
        final String desc = create().alternatives(FactoryJavaEEImpl.instance().alternatives10().stereotype(TestAlternativeStereoType.class.getName())
            ).exportAsString();
        log.info(desc);
    ...
    public void shouldBeAbleToAddAlternativeStereoTypes() throws Exception {
        final String desc = create().alternatives(FactoryJavaEEImpl.instance().alternatives10()
    ...
    public void shouldNotBeAbleToAddNonAlternativeClass() {
        create().alternatives(FactoryJavaEEImpl.instance().alternatives10().clazz(String.class.getName()));
    }

    @Test
    public void shouldBeAbleToAddAlternativeClass() throws Exception {
        final String desc = create().alternatives(FactoryJavaEEImpl.instance().alternatives10().clazz(TestAlternativeClass.class.getName()))
            .exportAsString();
    ...
    public void shouldNotBeAbleToAddNonInterceptor() throws Exception {
        create().interceptors(FactoryJavaEEImpl.instance().interceptors10().clazz(String.class.getName()));
    }

    @Test
    public void shouldBeAbleToAddInterceptor() throws Exception {
        final String desc = create().interceptors(FactoryJavaEEImpl.instance().interceptors10().clazz(TestInterceptor.class.getName()))
            .exportAsString();
    ...
    public void shouldBeAbleToAddInterceptors() throws Exception {
        final String desc = create().interceptors(FactoryJavaEEImpl.instance().interceptors10()
    ...
    public void shouldNotBeAbleToAddNonDecorator() throws Exception {
        create().decorators(FactoryJavaEEImpl.instance().decorators10().clazz(String.class.getName()));
    }

    @Test
    public void shouldBeAbleToAddDescorator() throws Exception {
        String desc = create().decorators(FactoryJavaEEImpl.instance().decorators10().clazz(TestDecorator.class.getName())).exportAsString();
    ...
    public void shouldBeAbleToAddDescorators() throws Exception {
        final String desc = create().decorators(FactoryJavaEEImpl.instance().decorators10()
    ...
    public void shouldBeAbleToGenerateComplexDescriptor() throws Exception {
        final BeansDescriptor beans = Descriptors.create(BeansDescriptor.class).interceptors(FactoryJavaEEImpl.instance().interceptors10()
            .clazz(TestInterceptor.class.getName(), TestAnotherInterceptor.class.getName()))
            .decorators(FactoryJavaEEImpl.instance().decorators10().clazz(TestDecorator.class.getName()))
            .alternatives(FactoryJavaEEImpl.instance().alternatives10()
