...
public class ApplicationDescriptorTestCase {
    ...
    public void testImportGeneratedApplicationXml() throws Exception {
        ...
        app6Descr.addDefaultNamespaces()
         ...
         .addIcon(app6Descr.factory().iconTypeJavaee6()
            .smallIcon("small-icon0")
            .largeIcon("large-icon0"))
         .initializeInOrder("true")
         .addModule(app6Descr.factory().moduleTypeApplication6()
            .ejb("ejb0")
            .altDd("alt-dd0"))
         .addSecurityRole(app6Descr.factory().securityRoleTypeJavaee6()
            .description("description1")
            .roleName("role-name0"))
         .libraryDirectory("library-directory0")
         .addEnvEntry(app6Descr.factory().envEntryTypeJavaee6()
            .description("description2")
            .envEntryName("env-entry-name0")
            .envEntryType("env-entry-type0")
            .envEntryValue("env-entry-value0")
            .mappedName("mapped-name0")
            .addInjectionTarget(app6Descr.factory().injectionTargetTypeJavaee6()
               .injectionTargetClass("injection-target-class0")
               .injectionTargetName("$"))
            .lookupName("lookup-name0"))
         .addEjbRef(app6Descr.factory().ejbRefTypeJavaee6()
         ...
         .addEjbLocalRef(app6Descr.factory().ejbLocalRefTypeJavaee6()
         ...
         .addServiceRef(app6Descr.factory().serviceRefTypeJavaeewebservicesclient13()
               ...
               .serviceQname("qName")
               .addPortComponentRef(app6Descr.factory().portComponentRefTypeJavaeewebservicesclient13()
                  .serviceEndpointInterface("service-endpoint-interface0")
                  .enableMtom(false)
                  .mtomThreshold(50)
                  .addressing(app6Descr.factory().addressingTypeJavaeewebservicesclient13()
                     .enabled(false)
                     .required(false)
                     .responses("ANONYMOUS"))
                  .respectBinding(app6Descr.factory().respectBindingTypeJavaeewebservicesclient13()
                     .enabled(false))
                  .portComponentLink("port-component-link0"))
               .addHandler(app6Descr.factory().handlerTypeJavaeewebservicesclient13()
                  ...
                  .addInitParam(app6Descr.factory().paramValueTypeJavaee6()
         ...
         .addResourceRef(app6Descr.factory().resourceRefTypeJavaee6()
         ...
         .addResourceEnvRef(app6Descr.factory().resourceEnvRefTypeJavaee6()
         ...
         .addMessageDestinationRef(app6Descr.factory().messageDestinationRefTypeJavaee6()
         ...
         .addPersistenceContextRef(app6Descr.factory().persistenceContextRefTypeJavaee6()
            .description("description11")
            .persistenceContextRefName("persistence-context-ref-name0")
            .persistenceUnitName("persistence-unit-name0")
            .persistenceContextType("Transaction")
            .addPersistenceProperty(app6Descr.factory().propertyTypeJavaee6()
               .name("name0")
               .value("value0"))
            ...
            .addInjectionTarget(app6Descr.factory().injectionTargetTypeJavaee6()
               ...
               .injectionTargetName("$")))
          .addPersistenceUnitRef(app6Descr.factory().persistenceUnitRefTypeJavaee6()
             ...
             .addInjectionTarget(app6Descr.factory().injectionTargetTypeJavaee6()
               ...
               .injectionTargetName("$")))
          .addMessageDestination(app6Descr.factory().messageDestinationTypeJavaee6()
          ...
          .addDataSource(app6Descr.factory().dataSourceTypeJavaee6()
             ...
             .user("user0")
             .password("password0")
             .addProperty(app6Descr.factory().propertyTypeJavaee6()
                .name("name2")
                .value("value1"))
             .loginTimeout(0)
             .transactional(false)
