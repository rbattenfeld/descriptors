...
public class ConnectorDescriptorTestCase {
    ...
    public void testGenExample() throws Exception {
      ...
      jca16Descr.addDefaultNamespaces()
         ...
         .addIcon(jca16Descr.factory().iconType6()
            .smallIcon("small-icon0")
            .largeIcon("large-icon0"))
         .vendorName("vendor-name0")
         .eisType("eis-type0")
         .resourceadapterVersion("resourceadapter-version0")
         .license(jca16Descr.factory().licenseType16()
            .description("description1")
            .licenseRequired(false))
         .resourceadapter(jca16Descr.factory().resourceadapterType16()
            .resourceadapterClass("resourceadapter-class0")
            .addConfigProperty(jca16Descr.factory().configPropertyType16()
            ...
            .outboundResourceadapter(jca16Descr.factory().outboundResourceadapterType16()
               .addConnectionDefinition(jca16Descr.factory().connectionDefinitionType16()
               ...
               .addAuthenticationMechanism(jca16Descr.factory().authenticationMechanismType16()
            ...
            .inboundResourceadapter(jca16Descr.factory().inboundResourceadapterType16()
               .messageadapter(jca16Descr.factory().messageadapterType16()
                  .addMessagelistener(jca16Descr.factory().messagelistenerType16()
                     .messagelistenerType("messagelistener-type0")
                     .activationspec(jca16Descr.factory().activationspecType16()
                        .activationspecClass("activationspec-class0")))))
            .addAdminobject(jca16Descr.factory().adminobjectType16()
               ...
               .addConfigProperty(jca16Descr.factory().configPropertyType16()
                  ...
                  .configPropertySupportsDynamicUpdates(false)
                  .configPropertyConfidential(false)))
            .addSecurityPermission(jca16Descr.factory().securityPermissionType16()
